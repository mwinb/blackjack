...
$(document).ready(function () {
     ...
     */
    var staticCards = [
        ['Cards/2_Clubs.png', true, 2, 'c'],
        ['Cards/2_Diamonds.png', true, 2, 'd'],
        ['Cards/2_Hearts.png', true, 2, 'h'],
        ['Cards/2_Spades.png', true, 2, 's'],
        ['Cards/3_clubs.png', true, 3, 'c'],
        ['Cards/3_Diamonds.png', true, 3, 'd'],
        ['Cards/3_Hearts.png', true, 3, 'h'],
        ['Cards/3_Spades.png', true, 3, 's'],
        ['Cards/4_Clubs.png', true, 4, 'c'],
        ['Cards/4_Diamonds.png', true, 4, 'd'],
        ['Cards/4_Hearts.png', true, 4, 'h'],
        ['Cards/4_Spades.png', true, 4, 's'],
        ['Cards/5_Clubs.png', true, 5, 'c'],
        ['Cards/5_Diamonds.png', true, 5, 'd'],
        ['Cards/5_Hearts.png', true, 5, 'h'],
        ['Cards/5_Spades.png', true, 5, 's'],
        ['Cards/6_Clubs.png', true, 6, 'c'],
        ['Cards/6_Diamonds.png', true, 6, 'd'],
        ['Cards/6_Hearts.png', true, 6, 'h'],
        ['Cards/6_spades.png', true, 6, 's'],
        ['Cards/7_Clubs.png', true, 7, 'c'],
        ['Cards/7_Diamonds.png', true, 7, 'd'],
        ['Cards/7_Hearts.png', true, 7, 'h'],
        ['Cards/7_Spades.png', true, 7, 's'],
        ['Cards/8_Clubs.png', true, 8, 'c'],
        ['Cards/8_Diamonds.png', true, 8, 'd'],
        ['Cards/8_Hearts.png', true, 8, 'h'],
        ['Cards/8_Spades.png', true, 8, 's'],
        ['Cards/9_Clubs.png', true, 9, 'c'],
        ['Cards/9_Diamonds.png', true, 9, 'd'],
        ['Cards/9_Hearts.png', true, 9, 'h'],
        ['Cards/9_Spades.png', true, 9, 's'],
        ['Cards/10_Clubs.png', true, 10, 'c'],
        ['Cards/10_Diamonds.png', true, 10, 'd'],
        ['Cards/10_Hearts.png', true, 10, 'h'],
        ['Cards/10_Spades.png', true, 10, 's'],
        ['Cards/J_Clubs.png', true, 10, 'c'],
        ['Cards/J_Diamonds.png', true, 10, 'd'],
        ['Cards/J_Hearts.png', true, 10, 'h'],
        ...
        ['Cards/K_Hearts.png', true, 10, 'h'],
        ['Cards/K_Spades.png', true, 10, 's'],
        ['Cards/A_Clubs.png', true, 11, 'c'],
        ['Cards/A_Diamonds.png', true, 11, 'd'],
        ['Cards/A_Hearts.png', true, 11, 'h'],
        ['Cards/A_Spades.png', true, 11, 's']
    ];

    var cards = $.extend(true, [], staticCards);

    var topCard = 'Cards/Top_Card.png';
